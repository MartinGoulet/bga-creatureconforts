...
$improvementStates = [
    ST_IMPROVEMENT_BICYCLE => [
        "phase" => "5",
        "name" => "bicycle",
        "descriptionmyturn" => clienttranslate('Bicycle : ${you} may select one of your workers to move to a different location'),
        "description" => clienttranslate('Bicycle : ${actplayer} may move one of his workers to a different location'),
        "type" => "activeplayer",
        "args" => "argBicycle",
